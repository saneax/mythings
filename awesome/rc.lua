...
--Initialize bat progressbar widget
batwidget = awful.widget.progressbar()
-- Progressbar for batwidget
batwidget:set_width(18)
...
-- Register bat progressbar widget
vicious.register(batwidget, vicious.widgets.bat, "$2", 61, "BAT1")

-- Initialize mem progressbar widget
memwidget = awful.widget.progressbar()
-- mem widget Progressbar properties
...
-- Register mem progressbar widget
